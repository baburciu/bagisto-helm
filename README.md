...
- **FrankenPHP**: Single-container architecture using [FrankenPHP](https://frankenphp.dev) (Caddy + embedded PHP) — no separate web server sidecar needed
...
- **Standalone MySQL Option**: Alternative MySQL deployment using official MySQL images with ARM64 support
